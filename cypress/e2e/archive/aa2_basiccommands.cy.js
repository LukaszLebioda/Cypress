...
describe("list of basic commands", () => {
  ...
  it("BASIC", () => {
    ...
    cy.get("div").within( () => { // "within" allows to act on multiple elements within a parent element, so it narrows the scope to that parent element ("find" allows to act on a single element only)
