...
module.exports = defineConfig({
	projectId: 'wicmv5',
	e2e: {
		// baseUrl: "your url goes here", // then in the test: cy.visit() or cy.visit("/something")
		...
		reporterOptions: {
			// ustawienia mochawesome reportera;
			charts: true,
		...
		retries: {
			// określamy, ile razy cy ma ponowić test (osobno dla run i dla open);
			runMode: 2,
			openMode: 1,
		},
